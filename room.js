...
var autoAwayMsg = ["Estou AFK, volto logo!"];
var autoSlpMsg = ["ZzZzZzZzZ"];
var autoWrkMsg = ["Estou ocupado no momento, deixe seu recado após o sinal... Beep!"];
...
delay();
$('#plugbot-js').remove();
log("Also, bem vindos à versão 1.0 do script dos anões. :3");
log("type '/commands' to see extra commands");
$('body').prepend('<style type="text/css" id="plug-css">' + "\n" + styles.join("\n") + "\n" + '</style>');
$('body').append('</div><div id="side-right" class="sidebar">' + '<div class="sidebar-handle"><span>|||</span></div>' + '<div class="sidebar-content"></div>' + '<div id="hr-div"><div><div id="hr-style"></div></div></div>' + '</div><div id="side-left" class="sidebar">' + '<div class="sidebar-handle" title="Exibir/esconder lista de usuários"><span>|||</span></div>' + '<div class="sidebar-content2"></div>' + '<div id="hr2-div2"><div><div id="hr2-style2"></div></div></div>' + '</div>');
